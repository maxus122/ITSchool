...
//! @defgroup  Others  	Разное
//! @brief   Технические функции.
...
//{----------------------------------------------------------------------------------------------------------------
//! @class   hrVegetables
//! @brief   Класс для описания обекта - овощ.
//}----------------------------------------------------------------------------------------------------------------
...
//{----------------------------------------------------------------------------------------------------------------
//! @brief   Функция, которая присваивает значение закрытой переменной IsCollecting (Собирается ли овощ).
//!
//! @param   valueCollecting   Значение IsCollecting.
//!
//! @return  Если операция была успешна -- true, иначе -- false.
//}----------------------------------------------------------------------------------------------------------------
...
//{----------------------------------------------------------------------------------------------------------------
//! @brief   Функция, которая возвращает значение закрытой переменной IsCollecting (Собирается ли овощ).
//!
//! @return  Если собирается -- true, иначе -- false.
//}----------------------------------------------------------------------------------------------------------------
...
//{----------------------------------------------------------------------------------------------------------------
//! @class   hrTrees
//! @brief   Класс для описания обекта - дерево.
//}----------------------------------------------------------------------------------------------------------------
...
//{----------------------------------------------------------------------------------------------------------------
//! @ingroup Others
//! @brief   Сохранение прогресса. 
//!
//! Сохраняет прогресс в текстовый файл в "Resources\\Saving.txt" относительно проекта.
//!
//! @param   act   Номер акта.
//! @param   houseUpgrade 	Уровень прокачки дома.
//! @param   treesUpgrade	Уровень прокачки деревьев.
//! @param   vegetablesUpgrade	Уровень прокачки овощей.
//!
//! @return  Если операция была успешна -- true, иначе -- false.
//}----------------------------------------------------------------------------------------------------------------
...
//{----------------------------------------------------------------------------------------------------------------
//! @ingroup Others
//! @brief   Загрузка прогресса. 
//!
//! Загружает прогресс из текстового файла в "Resources\\Saving.txt" относительно проекта.
//!
//! @param   act   Номер акта.
//! @param   houseUpgrade 	Уровень прокачки дома.
//! @param   treesUpgrade	Уровень прокачки деревьев.
...
//{----------------------------------------------------------------------------------------------------------------
//! @ingroup Others
//! @brief   Функция, проверяющая, существует ли файл. 
//!
//! @param   filePath   Путь к файлу относительно проекта.
//!
