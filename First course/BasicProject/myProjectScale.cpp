    ...
    void drawTimon(int x, int y, int timonEar, int timonLeg, int timonScale, bool timonTale, bool timonHair, COLORREF timonBallyColor, COLORREF timonBackColor, COLORREF timonHairColor, COLORREF timonLimbColor);
    void drawPig(int x, int y, int pigEar, int pigHand, int pigScale, bool pigEyes, bool pigLeg, COLORREF pigEarColor, COLORREF pigNoseColor, COLORREF pigShirtColor, COLORREF pigSkinColor);
    ...
    void drawFly(int x, int y, int flyHand, int flyLeg, int flyScale, bool flyHair, bool flyWings, COLORREF flyRothColor, COLORREF flyShirtColor, COLORREF flySkinColor, COLORREF flyEyesColor);
    ...
    void drawSkubi(int x, int y, int SkubiScale, bool SkubiKeychain, bool skubyiMoles, bool SkubiEyes, bool SkubiNose, COLORREF SkubiStrokePanelColor, COLORREF SkubiSkinColor, COLORREF SkubiCollarColor, COLORREF SkubiEyesColor);
    ...
    int main( )
        {
            ...
            drawTimon(timonX, timonY, timonEar, timonLeg, timonScale, timonTale, timonHair, timonBallyColor, timonBackColor, timonHairColor, timonLimbColor);
            drawPig(pigX, pigY, pigEar, pigHand, pigScale, pigEyes, pigLeg, pigEarColor, pigNoseColor, pigShirtColor, pigSkinColor);
            ...
            drawFly(flyX, flyY, flyHand, flyLeg, flyScale, flyHair, flyWings, flyRothColor, flyShirtColor, flySkinColor, flyEyesColor);
            ...
            drawSkubi(SkubiX, SkubiY, SkubiScale, SkubiKeychain, skubyiMoles, SkubiEyes, SkubiNose, SkubiStrokePanelColor, SkubiSkinColor, SkubiCollarColor, SkubiEyesColor);
    ...
    void drawTimon(int x, int y, int timonEar, int timonLeg, int timonScale, bool timonTale, bool timonHair, COLORREF timonBallyColor, COLORREF timonBackColor, COLORREF timonHairColor, COLORREF timonLimbColor)
    {
        //Тимон
                ...
                txSetFillColor (timonLimbColor);
                txFloodFill(x+(-91*timonScale), y+(-26*timonScale));
                ...
                txSetFillColor (timonLimbColor);
                txFloodFill(x+(-35*timonScale), y+(-52*timonScale));
                ...
                txSetFillColor (timonLimbColor);
                txFloodFill(x+(104*timonScale), y+(-29*timonScale));
                ...
                txSetFillColor(timonLimbColor);
                txFloodFill(x+(129*timonScale), y+(-7*timonScale));
                ...
                txSetFillColor(WHITE);
                txFloodFill(x+(15*timonScale), y+(-9*timonScale));
                txFloodFill(x+(20*timonScale), y+(-14*timonScale));
    }
    ...
    void drawFly(int x, int y, int flyHand, int flyLeg, int flyScale, bool flyHair, bool flyWings, COLORREF flyRothColor, COLORREF flyShirtColor, COLORREF flySkinColor, COLORREF flyEyesColor)
    {
        //Муха
                ...
                if (flyWings){
                    ...
                    txFloodFill(x+(147*flyScale), y+(155*flyScale));}}
                ...
                txFloodFill(x+(130*flyScale), y+(17*flyScale));
                ...
                if (flyWings){
                    txSetFillColor(LIGHTBLUE);
                    txFloodFill(x+(43*flyScale), y+(175*flyScale));
                    txFloodFill(x+(91*flyScale), y+(205*flyScale));}
    }
    ...
    void drawMinion(int x, int y, int MinionHand, int MinionScale, bool MinionGlasses, bool MinionHair, bool MinionRoth, COLORREF MinionEyesColor, COLORREF MinionPantsColor, COLORREF MinionGlassesColor, COLORREF MinionPocketColor)
    {
        //Миньон
                ...
                txSetFillColor(BLACK);
                txFloodFill(x+(78*MinionScale), y+(292*MinionScale));
                ...
                txSetFillColor(MinionPantsColor);
                txFloodFill(x+(155*MinionScale), y+(285*MinionScale));
                ...
                txSetFillColor(BLACK);
                txFloodFill(x+(153*MinionScale), y+(288*MinionScale));
                ...
                txFloodFill(x+(113*MinionScale), y+(209*MinionScale));
                ...
                if (MinionHand == 0){
                    ...
                    txLine(x+(2*MinionScale), y+(227*MinionScale), x+(2*MinionScale), y+(144*MinionScale));
                    txSetFillColor(YELLOW);
                    txFloodFill(x+(22*MinionScale), y+(181*MinionScale));
                ...
                txLine(x+(2*MinionScale), y+(195*MinionScale), x+(29*MinionScale), y+(195*MinionScale));
                txSetFillColor(MinionPantsColor);
                txFloodFill(x+(15*MinionScale), y+(207*MinionScale));

                txSetFillColor(MinionPantsColor);
                txFloodFill(x+(219*MinionScale), y+(209*MinionScale));
                txSetFillColor(YELLOW);
                txFloodFill(x+(216*MinionScale), y+(176*MinionScale));
                txSetFillColor(YELLOW);
                txFloodFill(x+(22*MinionScale), y+(181*MinionScale));
                ...
                txSetFillColor(YELLOW);
                txFloodFill(x+(75*MinionScale), y+(107*MinionScale));
    ...
    void drawSkubi(int x, int y, int SkubiScale, bool SkubiKeychain, bool skubyiMoles, bool SkubiEyes, bool SkubiNose, COLORREF SkubiStrokePanelColor, COLORREF SkubiSkinColor, COLORREF SkubiCollarColor, COLORREF SkubiEyesColor)
    {
        //Скуби
                ...
                if (SkubiKeychain){
                    ...
                    txSetFillColor(YELLOW);
                    txFloodFill(x+(44*SkubiScale), y+(22*SkubiScale));
                    txFloodFill(x+(35*SkubiScale), y+(68*SkubiScale));
                    txSetFillColor(SkubiCollarColor);
                    txFloodFill(x+(54*SkubiScale), y+(20*SkubiScale));}
                else{
                    txSetColor(SkubiStrokePanelColor, 3);
                ...
                txSetFillColor(SkubiStrokePanelColor);
                txFloodFill(x+(94*SkubiScale), y+(-166*SkubiScale));
                txSetFillColor(SkubiSkinColor);
                txFloodFill(x+(94*SkubiScale), y+(-26*SkubiScale));
                //txFloodFill(x+(165*SkubiScale), y+(-285*SkubiScale));
                txFloodFill(x+(86*SkubiScale), y+(-131*SkubiScale));
                txFloodFill(x+(48*SkubiScale), y+(-292*SkubiScale));
                txFloodFill(x+(39*SkubiScale), y+(-276*SkubiScale));
                txSetFillColor(SkubiCollarColor);
                txFloodFill(x+(26*SkubiScale), y+(12*SkubiScale));
                txFloodFill(x+(74*SkubiScale), y+(38*SkubiScale));
